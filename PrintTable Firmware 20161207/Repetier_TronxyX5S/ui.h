...
#define UI_HAS_BACK_KEY 0     // modifying to 1 from 0
...
#else  // RAMPS
#undef BEEPER_PIN
#define BEEPER_PIN             -1  // here I am disabling beeper pin 37 as it will be used for backlight
#define UI_BACKLIGHT_PIN       37  // here I am defining the backlight
#define UI_DISPLAY_RS_PIN      16
#define UI_DISPLAY_RW_PIN      -1
#define UI_DISPLAY_ENABLE_PIN  17
#define UI_DISPLAY_D0_PIN      23
...
#if UI_RESET_PIN > -1
  UI_KEYS_BUTTON_LOW(UI_RESET_PIN, UI_ACTION_SHOW_USERMENU1);
#endif
}
inline void uiCheckSlowEncoder() {}
void uiCheckSlowKeys(uint16_t &action) {}
